<template>
  <div class="search">
    ...
    <confirm ref="confirm" @confirm="clearSearchHistory" text="是否清空所有搜索历史是否清空所有搜索历史是否清空所有搜索历史s是否清空所有搜索历史s是否清空所有搜索历史s是否清空所有搜索历史s是否清空所有搜索历史s" confirmBtnText="清空"></confirm>
